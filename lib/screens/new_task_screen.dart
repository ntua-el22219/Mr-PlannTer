              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Form(
                    ...
                    child: ListView(
                      children: [
                        Center(child: Text(title, style: AppTextStyles.heading2.copyWith(fontSize: 22, fontWeight: FontWeight.bold))),
                        ...
                        if (isTask) ...[
                          Row(
                            children: [
                              Expanded(child: Text("Frequency (days/week)", style: AppTextStyles.taskHour.copyWith(fontWeight: FontWeight.bold, color: Colors.blue.shade900))),
                          ...
                          Row(
                            children: [
                              Expanded(child: Text("Duration (minutes)", style: AppTextStyles.taskHour.copyWith(fontWeight: FontWeight.bold, color: Colors.blue.shade900))),
                              const SizedBox(width: 10),
                        ...
                        Text("Importance", style: AppTextStyles.taskHour.copyWith(fontWeight: FontWeight.bold, color: Colors.blue.shade900)),
                        ...
                        Text(isTask ? "Plan your task:" : "Date & Time", style: AppTextStyles.caption),
                        const SizedBox(height: 5),
                        
                        Row(
                          children: [
                            Text("Date ", style: AppTextStyles.taskHour.copyWith(fontWeight: FontWeight.bold)),
                            Expanded(
                              child: GestureDetector(
                                onTap: _pickDate,
                                child: AbsorbPointer(
                        ...
                        Row(
                          children: [
                            Text("Time ", style: AppTextStyles.taskHour.copyWith(fontWeight: FontWeight.bold)),
                            SizedBox(
                              width: 100,
                              child: GestureDetector(
                                onTap: _pickTime,
